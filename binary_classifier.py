...
def exploratory_analysis_plots(training_data):
    """
    Function to plot the target class imbalance, missing values and distribution of numerical columns in the training dataset
    :param training_data: pd.DataFrame: the training dataset to analyze
    """
